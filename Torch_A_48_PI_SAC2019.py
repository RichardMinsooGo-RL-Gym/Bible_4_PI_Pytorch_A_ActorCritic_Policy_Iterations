...
class SACAgent:
    ...
    def __init__(self, env, gamma, tau, delay_step, critic_lr, actor_lr, buffer_maxlen):
    ...
    def train_step(self, batch_size):
        ...
        next_q_target = torch.min(next_Q1_targs, next_Q2_targs) - next_log_pi
...
if __name__ == "__main__":
    ...
    agent = SACAgent(env, gamma, tau, delay_step, critic_lr, actor_lr, buffer_maxlen)
