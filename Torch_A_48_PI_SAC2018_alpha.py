...
class SACAgent:
    ...
    def __init__(self, env, gamma, tau, delay_step, alpha, v_lr, critic_lr, actor_lr, buffer_maxlen):
...
if __name__ == "__main__":
    ...
    agent = SACAgent(env, gamma, tau, delay_step, value_lr, alpha, critic_lr, actor_lr, buffer_maxlen)
